...
public class PaySectionTest extends LoadTest {
    ...
    void setUp() {
        ...
        steps = new PaySectionSteps(paySection, wait);
    }
    ...
    @DisplayName("Проверка плейсхолдеров для оплаты услуг связи")
    @Epic("MTS Payments")
    @Feature("Онлайн пополнение")
    @Story("Проверка плейсхолдеров")
    @Test 
    ...
    @DisplayName("Проверка плейсхолдеров для оплаты домашнего интернета")
    @Epic("MTS Payments")
    @Feature("Онлайн пополнение")
    @Story("Проверка плейсхолдеров")
    @Test
    ...
    @DisplayName("Проверка плейсхолдеров для оплаты рассрочки")
    @Epic("MTS Payments")
    @Feature("Онлайн пополнение")
    @Story("Проверка плейсхолдеров")
    @Test
    ...
    @DisplayName("Проверка плейсхолдеров для оплаты задолженности")
    @Epic("MTS Payments")
    @Feature("Онлайн пополнение")
    @Story("Проверка плейсхолдеров")
    @Test
